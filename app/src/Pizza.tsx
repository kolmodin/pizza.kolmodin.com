...
const Pizza: FunctionComponent<{ initialDoughBalls?: number }> = ({ initialDoughBalls = 4 }) => {
    ...
    return <>
        ...
        <p>Väg upp mjölet i degblandarens bunke. Lös upp torrjästen i ljummet vatten. Häll ner vattnet och jästen i bunken. Tillsätt det kalla vattnet. Tillsätt poolishen.
           ...
           Väg degen. Den borde väga runt {totalWeight.toFixed(0)}g. Med {doughBalls} bollar blir det {ballWeight}g per boll.
